...
- 🔍 **Поиск по ключевым словам** — до 3 страниц (~300 товаров), Chrome автоматически проходит Qrator
...
- 🤖 **AI-ассистент (Gemini)** — анализ ниши, ценовой анализ, анализ отзывов, SEO-оптимизация описаний
